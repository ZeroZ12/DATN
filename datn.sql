...
-- Thời gian đã tạo: Th6 18, 2025 lúc 03:54 AM
...
(1, 1, 4, 13, 'PC TTG GAMING PRO i7 14700KF - RTX 5060 Ti 8GB (ALL NEW - Bảo hành 36 tháng)', 2, 35980000.00, 36, '2025-06-17 20:44:58', '2025-06-17 20:44:58'),
(2, 1, 5, 17, 'PC MAXIMUM GAMING i5 12400F - RTX 3070 8GB ( All NEW - Bảo hành 36 tháng)', 1, 19680000.00, 36, '2025-06-17 20:44:58', '2025-06-17 20:44:58'),
(3, 2, 6, 25, 'PC AMD GAMING MAX PERFORMANCE Ryzen 7 7800X3D - RTX 5090 32GB OC', 1, 16280000.00, 36, '2025-06-17 20:46:00', '2025-06-17 20:46:00'),
(4, 3, 6, 25, 'PC AMD GAMING MAX PERFORMANCE Ryzen 7 7800X3D - RTX 5090 32GB OC', 1, 16280000.00, 36, '2025-06-17 20:50:35', '2025-06-17 20:50:35'),
(5, 4, 4, 13, 'PC TTG GAMING PRO i7 14700KF - RTX 5060 Ti 8GB (ALL NEW - Bảo hành 36 tháng)', 1, 35980000.00, 36, '2025-06-17 20:53:29', '2025-06-17 20:53:29');
...
CREATE TABLE `dia_chi_nguoi_dungs` (
  ...
  `so_dien_thoai_nguoi_nhan` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dia_chi_day_du` text COLLATE utf8mb4_unicode_ci,
  `tinh_thanh_pho` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `dia_chi_nguoi_dungs` (`id`, `id_user`, `ten_nguoi_nhan`, `so_dien_thoai_nguoi_nhan`, `dia_chi_day_du`, `tinh_thanh_pho`, `quan_huyen`, `phuong_xa`, `la_mac_dinh`, `created_at`, `updated_at`) VALUES
(1, 11, 'Trần Pohng', '2331321313', '22', 'Hà Nội', 'Nam Từ Liêm', 'Hội', 1, '2025-06-17 20:44:09', '2025-06-17 20:44:09');
...
CREATE TABLE `don_hangs` (
  ...
  `trang_thai` enum('cho_xu_ly','dang_giao','hoan_thanh','huy') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `don_hangs` (`id`, `ma_don`, `id_user`, `id_dia_chi_nguoi_dungs`, `id_phuong_thuc_thanh_toan`, `tong_tien`, `trang_thai`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'DH1750218298', 11, 1, 1, 91640000.00, 'cho_xu_ly', '2025-06-17 20:44:58', '2025-06-17 20:44:58', NULL),
(2, 'DH1750218360', 11, 1, 1, 16280000.00, 'cho_xu_ly', '2025-06-17 20:46:00', '2025-06-17 20:46:00', NULL),
(3, 'DH1750218635', 11, 1, 1, 16280000.00, 'cho_xu_ly', '2025-06-17 20:50:35', '2025-06-17 20:50:35', NULL),
(4, 'DH1750218809', 11, 1, 2, 35980000.00, 'cho_xu_ly', '2025-06-17 20:53:29', '2025-06-17 20:53:29', NULL);
...
(1, 11, 'chinh', 5, NULL, '2025-06-16 19:11:04', '2025-06-16 21:25:36');
...
(1, 'eveniet', 'phan_tram', 6.43, '2025-06-13 19:33:02', '2025-07-13 19:33:02', 1, '2025-06-13 19:33:02', '2025-06-16 21:25:01', '2025-06-16 21:25:01'),
(2, 'dolores', 'phan_tram', 46.01, '2025-06-13 19:33:02', '2025-07-13 19:33:02', 1, '2025-06-13 19:33:02', '2025-06-16 21:25:04', '2025-06-16 21:25:04'),
(3, 'iusto', 'phan_tram', 43.17, '2025-06-13 19:33:02', '2025-07-13 19:33:02', 1, '2025-06-13 19:33:02', '2025-06-16 21:25:06', '2025-06-16 21:25:06'),
(4, 'similique', 'phan_tram', 10.31, '2025-06-13 19:33:02', '2025-07-13 19:33:02', 1, '2025-06-13 19:33:02', '2025-06-16 21:25:09', '2025-06-16 21:25:09'),
(5, 'Giam50%', 'phan_tram', 50.00, '2025-06-13 17:00:00', '2025-07-13 17:00:00', 1, '2025-06-13 19:33:02', '2025-06-16 21:23:09', NULL);
...
(25, '2025_06_18_034716_add_deleted_at_to_don_hangs_table', 3);
...
('Hnzx79l5n6vUK9zN1PtzmdCTYSKzn3e4olRKmEj5', 11, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/136.0.0.0 Safari/537.36', '', 1750218827);
...
(1, 'user1', 'user1@example.com', '2025-06-13 19:32:59', '$2y$12$OODqcMertbP4ygMWN9CRt./0WZSk88fmTKfM6qqm742ercqh3QXMG', 'Prof. Camren Bailey Sr.', '(240) 520-1205', 'quan_tri', 'vo_hieu', 'FnsT7TJqKN', '2025-06-13 19:33:00', '2025-06-13 19:33:00', NULL),
(2, 'user2', 'user2@example.com', '2025-06-13 19:33:00', '$2y$12$yAqcg36rftmFB./MtmKDDuZXvTQafe07Jpt/YwjodgRiYuVxmylIC', 'Lelah Lubowitz', '408-633-4036', 'quan_tri', 'hoat_dong', 'ACB2pRQ4ch', '2025-06-13 19:33:00', '2025-06-13 19:33:00', NULL),
(3, 'user3', 'user3@example.com', '2025-06-13 19:33:00', '$2y$12$i2eZ2.3xIIkUBzdlnX.LC./aL.zT7QcGW.tMExRm/ecAFDJulCPWC', 'Antonina Thompson', '(559) 971-4540', 'quan_tri', 'vo_hieu', 'aD4HhScONU', '2025-06-13 19:33:00', '2025-06-13 19:33:00', NULL),
(4, 'user4', 'user4@example.com', '2025-06-13 19:33:00', '$2y$12$8omrclgnPqmO/L9p.kCspejSXrXraQTM3M/3/LenRL6uNSb4fGd7e', 'Mr. Wilber Hane', '+13375366544', 'quan_tri', 'vo_hieu', 'cRlOiuO3UP', '2025-06-13 19:33:01', '2025-06-13 19:33:01', NULL),
(5, 'user5', 'user5@example.com', '2025-06-13 19:33:01', '$2y$12$zh4FvcDvftTg7DUsGjOuBuml.fs3lvuUgzFM03C6rDpE.sz62yrpu', 'Walton Orn', '+1-979-891-8495', 'khach_hang', 'vo_hieu', 'n1f4cj382J', '2025-06-13 19:33:01', '2025-06-13 19:33:01', NULL),
(6, 'user6', 'user6@example.com', '2025-06-13 19:33:01', '$2y$12$nI6o30y14OIYX/ZnipHV4e1NXKch.POa7rAn5jtLAtcyyxwlK.V7a', 'Brisa Lehner', '(309) 616-2416', 'khach_hang', 'vo_hieu', 'NaQxuyl2Ty', '2025-06-13 19:33:01', '2025-06-13 19:33:01', NULL),
(7, 'user7', 'user7@example.com', '2025-06-13 19:33:01', '$2y$12$gOCSRUBfsYlltSa0HIMSa.BXlnpndoQlRuleL2.UmzmB4Fxt9zVZq', 'Jamie Williamson', '508-290-1633', 'quan_tri', 'vo_hieu', '17GWn5nMyy', '2025-06-13 19:33:01', '2025-06-13 19:33:01', NULL),
(8, 'user8', 'user8@example.com', '2025-06-13 19:33:01', '$2y$12$H.QiMLtUW4q7X7GaL4E.deYoOcr3fGAvzQUnYr9H2Dk6I9EaGbc5S', 'Aidan Nicolas', '1-689-251-7249', 'quan_tri', 'hoat_dong', 'RziEnSZFE3', '2025-06-13 19:33:01', '2025-06-13 19:33:01', NULL),
(9, 'user9', 'user9@example.com', '2025-06-13 19:33:01', '$2y$12$ixlZdiEmUJXdXHOYUHjpN.DafA/VDVVdsbUSutgKh7U3HS77ZWpqm', 'Aglae Rosenbaum', '1-828-347-0665', 'quan_tri', 'vo_hieu', '7db1v3aAs1', '2025-06-13 19:33:02', '2025-06-13 19:33:02', NULL),
(10, 'user10', 'user10@example.com', '2025-06-13 19:33:02', '$2y$12$5pu9RqASQ47/MTntaYx6L.t9/i.EewfUVHhwqQB1AKMlXaHLMjQyy', 'Orin Ziemann IV', '1-224-881-0629', 'khach_hang', 'hoat_dong', 'n3GIMyEaPi', '2025-06-13 19:33:02', '2025-06-13 19:33:02', NULL),
(11, 'phong', 'phongtvph52541@gmail.com', NULL, '$2y$12$hruKOW4kmugF0gVGLncAheSp9QkCsPq9vmQFQXfMqoU3WEsEHd8wy', 'Trần Văn Phong', '0325413923', 'quan_tri', 'hoat_dong', NULL, '2025-06-14 08:43:27', '2025-06-14 08:43:27', NULL);
