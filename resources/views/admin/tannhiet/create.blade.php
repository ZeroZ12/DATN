...
@section('title', 'Thêm Tản Nhiệt')

@section('content')
    <div class="container">
        <h2 class="mb-4">Thêm Tản Nhiệt mới</h2>

        <form action="{{ route('admin.tannhiet.store') }}" method="POST">
            @csrf

            <div class="mb-3">
                <label for="ten" class="form-label">Loại Tản Nhiệt <span class="text-danger">*</span></label>
            ...
            <a href="{{ route('admin.tannhiet.index') }}" class="btn btn-secondary">Quay lại</a>
        </form>
    </div>
@endsection
