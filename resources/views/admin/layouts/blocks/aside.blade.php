    ...
    <div id="sidebar-menu">
        <ul class="sidebar-menu" id="simple-bar">
            ...
            <li class="sidebar-list">
                <a href="{{ route('admin.index') }}" class="sidebar-link d-flex text-start">
                    <span class="me-2" style="width: 1.25em; display: inline-block;"></span>
                    <span class="flex-grow-1">Dashboard</span>
                </a>
            </li>
             <li class="sidebar-list">
                <a href="{{ route('admin.thongke') }}" class="sidebar-link d-flex text-start">
                    <span class="me-2" style="width: 1.25em; display: inline-block;"></span>
            ...
            {{-- Quản lý chung --}}
            <li class="sidebar-list">
                <a class="sidebar-link d-flex text-start" href="javascript:void(0)">
                ...
                <ul class="sidebar-submenu" style="display: none;">
                    <li>
                        <a href="{{ route('admin.sanpham.index') }}" class="d-flex text-start">
                            <i class="fa fa-cube me-2"></i>
                            <span class="flex-grow-1">Sản phẩm</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.danhmuc.index') }}" class="d-flex text-start">
                            <i class="fa fa-list me-2"></i>
                            <span class="flex-grow-1">Danh mục</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.users.index') }}" class="d-flex text-start">
                            <i class="fa fa-users me-2"></i>
                            <span class="flex-grow-1">Người dùng</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.banner.index') }}" class="d-flex text-start">
                    ...
                    <li>
                        <a href="{{ route('admin.danhgias.index') }}"
                            class="d-flex text-start {{ Request::routeIs('admin.danhgias.*') ? 'active' : '' }}">
            ...
            <li class="sidebar-list">
                ...
                <ul class="sidebar-submenu" style="display: none;">
                    <li>
                        <a href="{{ route('admin.chip.index') }}" class="d-flex text-start">
                            <i class="fa fa-microchip me-2"></i>
                            <span class="flex-grow-1">Chip</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.mainboard.index') }}" class="d-flex text-start">
                            <i class="fa fa-server me-2"></i>
                            <span class="flex-grow-1">Mainboard</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.gpu.index') }}" class="d-flex text-start">
                            <i class="fa fa-video me-2"></i>
                            <span class="flex-grow-1">GPU</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.ram.index') }}" class="d-flex text-start">
                            <i class="fa fa-memory me-2"></i>
                            <span class="flex-grow-1">RAM</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.ocung.index') }}" class="d-flex text-start">
                            <i class="fa fa-hdd me-2"></i>
                            <span class="flex-grow-1">Ổ cứng</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.nguon.index') }}" class="d-flex text-start">
                            <i class="fa fa-plug me-2"></i>
                            <span class="flex-grow-1">Nguồn</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.tannhiet.index') }}" class="d-flex text-start">
                            <i class="fa fa-fan me-2"></i>
                            <span class="flex-grow-1">Tản Nhiệt</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.case.index') }}" class="d-flex text-start">
            ...
            <li class="sidebar-list">
                ...
                <ul class="sidebar-submenu" style="display: none;">
                    <li>
                        <a href="{{ route('admin.thuonghieu.index') }}" class="d-flex text-start">
                            <i class="fa fa-star me-2"></i>
                            <span class="flex-grow-1">Thương hiệu</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.sukien.index') }}" class="d-flex text-start">
                            <i class="fa fa-bolt me-2"></i>
                            <span class="flex-grow-1">Sự kiện</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.magiamgia.index') }}" class="d-flex text-start">
            ...
            <li class="sidebar-list">
                ...
                <ul class="sidebar-submenu" style="display: none;">
                    <li>
                        <a href="{{ route('admin.phuongthucthanhtoan.index') }}" class="d-flex text-start">
            ...
            <li class="sidebar-list mt-3">
                <a href="{{ route('admin.don-hang.index') }}" class="sidebar-link d-flex text-start">
                    <svg class="stroke-icon me-2">
                        <use href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#Home"></use>
                    </svg>
            ...
            <li class="sidebar-list mt-3">
                <a href="{{ route('client.home') }}" class="sidebar-link d-flex text-start">
                    <svg class="stroke-icon me-2">
                        <use href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#Home"></use>
                    </svg>
