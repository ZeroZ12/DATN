...
@section('content')
    <div class="container">
        <h2 class="mb-4">Sửa ổ cứng: {{ $oCung->dung_luong }} ({{ $oCung->loai }})</h2>
        ...
        <form action="{{ route('admin.ocung.update', $oCung->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="loai" id="loai" class="form-control" value="{{ old('loai', $oCung->loai) }}">
                @error('loai')
            ...
            <div class="mb-3">
                ...
                <input type="number" name="gia" id="gia" class="form-control" value="{{ old('gia',$oCung->gia) }}">
                @error('gia')
            ...
            <div class="mb-3">
                ...
                <input type="number" name="gia_sale" id="gia_sale" class="form-control" value="{{ old('gia_sale',$oCung->gia_sale) }}">
                @error('gia_sale')
                    <div class="text-danger small">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="mo_ta" id="mo_ta" class="form-control" rows="4">{{ old('mo_ta', $oCung->mo_ta) }}</textarea>
                @error('mo_ta')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
