...
@section('title', 'Thêm nguon')

@section('content')
    <div class="container">
        <h2 class="mb-4">Thêm nguồn mới</h2>

        <form action="{{ route('admin.nguon.store') }}" method="POST">
            @csrf

            <div class="mb-3">
                <label for="ten" class="form-label">Nguồn <span class="text-danger">*</span></label>
            ...
            <a href="{{ route('admin.nguon.index') }}" class="btn btn-secondary">Quay lại</a>
        </form>
    </div>
@endsection
