...
<div class="container">
    ...
    <form action="{{ route('admin.sanpham.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            @error('id_category') <div class="text-danger">{{ $message }}</div> @enderror
        </div>
        ...
        <div class="form-group">
            ...
            @error('id_brand') <div class="text-danger">{{ $message }}</div> @enderror
        </div>
        ...
        <div class="form-group">
            ...
            @error('id_chip') <div class="text-danger">{{ $message }}</div> @enderror
        </div>
        ...
        <div class="form-group">
            ...
            @error('id_mainboard') <div class="text-danger">{{ $message }}</div> @enderror
        </div>
        ...
        <div class="form-group">
            ...
            @error('id_gpu') <div class="text-danger">{{ $message }}</div> @enderror
        </div>
        ...
        <div class="form-group">
            ...
            @error('bao_hanh_thang') <div class="text-danger">{{ $message }}</div> @enderror
        </div>
        ...
        <div class="form-group">
            ...
            @error('anh_phu.*') <div class="text-danger">{{ $message }}</div> @enderror
        </div>
        ...
        <div class="form-group">
            ...
            @foreach($rams as $ram)
                <label class="me-3">
                    <input type="checkbox" class="ram-checkbox" value="{{ $ram->id }}" data-label="{{ $ram->dung_luong }}">
                    {{ $ram->dung_luong }}
                </label>
            @endforeach
        </div>
        ...
        <div class="form-group">
            ...
            @foreach($o_cungs as $oc)
                <label class="me-3">
                    <input type="checkbox" class="ocung-checkbox" value="{{ $oc->id }}" data-label="{{ $oc->dung_luong }}">
                    {{ $oc->dung_luong }}
                </label>
            @endforeach
        </div>
