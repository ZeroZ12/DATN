        ...
        <tbody>
            @forelse($thuongHieus as $thuongHieu)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.thuonghieu.edit', $thuongHieu->id) }}" class="btn btn-sm btn-warning">Sửa</a>
                        <form action="{{ route('admin.thuonghieu.destroy', $thuongHieu->id) }}" method="POST" class="d-inline-block"
