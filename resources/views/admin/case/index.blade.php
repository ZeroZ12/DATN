...
@section('content')
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <a href="{{ route('admin.case.trash') }}" class="btn btn-outline-secondary me-2">🗑️ Thùng rác</a>
                        ...
                        @forelse($cases as $case)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.case.edit', $case->id) }}" class="btn btn-sm btn-warning me-1">
                                        ✏️ Sửa
                                    </a>
                                    <a href="{{ route('admin.case.show', $case->id) }}" class="btn btn-sm btn-info me-1">
                                        👁️ Xem
                                    </a>
