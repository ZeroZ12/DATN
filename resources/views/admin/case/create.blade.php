...
@section('title', 'Thêm Case')

@section('content')
    <div class="container">
        <h2 class="mb-4">Thêm Case mới</h2>

        <form action="{{ route('admin.case.store') }}" method="POST">
            @csrf

            <div class="mb-3">
                <label for="ten" class="form-label">Name Case <span class="text-danger">*</span></label>
            ...
            <a href="{{ route('admin.case.index') }}" class="btn btn-secondary">Quay lại</a>
        </form>
    </div>
@endsection
