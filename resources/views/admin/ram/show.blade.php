    ...
    <div class="container">
        ...
        <div class="card p-4">
            ...
            <ul class="list-unstyled">
                ...
                <li><strong>Giá:</strong> {{ number_format($ram->gia ?? '0') }} đ</li>
                <li><strong>Giá Sale:</strong> {{ number_format((float)$ram->gia_sale ?? '0') }} đ</li>
        ...
        <div class="mt-4">
            ...
            <a href="{{ route('admin.ram.edit', $ram->id) }}" class="btn btn-outline-warning">Chỉnh sửa</a>
        </div>
    </div>
@endsection
