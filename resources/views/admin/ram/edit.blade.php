    ...
    <div class="container">
        ...
        <form action="{{ route('admin.ram.update', $ram->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="gia" id="gia" class="form-control" value="{{ old('gia',$ram->gia) }}">
                @error('gia')
            ...
            <div class="mb-3">
                ...
                <input type="number" name="gia_sale" id="gia_sale" class="form-control" value="{{ old('gia_sale',$ram->gia_sale) }}">
                @error('gia_sale')
                    <div class="text-danger small">{{ $message }}</div>
                @enderror
            </div>
