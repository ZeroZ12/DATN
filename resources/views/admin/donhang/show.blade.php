    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="row gy-2">
                ...
                <div class="col-md-6"><strong>Địa chỉ nhận hàng:</strong> {{ $donHang->diaChiNguoiDung->dia_chi_day_du ?? '---' }}</div>
                ...
                <div class="col-md-6"><strong>Tổng tiền gốc:</strong> {{ number_format($donHang->tong_tien_goc, 0) }}đ</div>
