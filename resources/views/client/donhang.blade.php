                    ...
                    <div class="text-end">
                        <div class="mb-2">
                            @if ($donHang->giam_gia > 0)
                                <div>
                                    Giảm giá: <span
                                        class="text-success">-{{ number_format($donHang->giam_gia, 0, ',', '.') }}₫</span>
                                </div>
                            @endif
                            Thành tiền: <span
                                class="text-danger fw-bold">{{ number_format($donHang->tong_tien, 0, ',', '.') }}₫</span>
                        </div>
                        ...
                        <div class="btn-group">
                            ...
                            @php
                                ...
                                if ($trangThai ==='giao_thanh_cong' && !$daQua3Ngay) {
                                    $coTheHoanTra = true;
                                }
                               if ($trangThai === 'da_huy' && $ycht && in_array($ycht->trang_thai, ['da_phe_duyet'])) {
        $coTheHoanTra = true;
    }
