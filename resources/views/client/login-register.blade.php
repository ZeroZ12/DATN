...
@section('content')
                        ...
                        <form id="registerForm" method="POST" action="{{ route('register') }}" style="display:none;">
                            ...
                            <div class="mb-3">
                                <input type="text" name="ten_dang_nhap"
                                    class="form-control form-control-lg @error('ten_dang_nhap') is-invalid @enderror"
                                    placeholder="Tên đăng nhập" value="{{ old('ten_dang_nhap') }}"> {{-- Đổi name email để phân biệt với login --}}
                                @error('ten_dang_nhap')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                <input type="email" name="email"
                                    class="form-control form-control-lg @error('email_register') is-invalid @enderror"
                                    placeholder="Email" value="{{ old('email') }}"> {{-- Đổi name email để phân biệt với login --}}
                            ...
                            <div class="mb-4">
                                <input type="password" name="password"
                                    class="form-control form-control-lg @error('password_register') is-invalid @enderror"
                                    placeholder="Mật khẩu"> {{-- Đổi name password để phân biệt với login --}}
    ...
    <script>
        ...
        @if (
            $errors->has('ho_ten') ||
                $errors->has('phone') ||
                $errors->has('password_register') ||
                $errors->has('password_confirmation') ||
                old('form_type') === 'register')
