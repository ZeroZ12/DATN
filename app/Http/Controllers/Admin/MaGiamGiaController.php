...
class MaGiamGiaController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        ...
        $data = $request->validate([
            ...
            'gia_tri_toi_da' => 'required_if:loai,phan_tram|digits_between:1,8',
            ...
            'gia_tri.digits_beetween' => 'Giá trị mã giảm giá tối đa 8 chữ số.',
            ...
            'gia_tri_toi_da.digits_between' => 'Giá trị tối đa không được vượt quá 8 chữ số.',
            'dieu_kien.numeric' => 'Điều kiện áp dụng phải là số.',
            'dieu_kien.min' => 'Điều kiện áp dụng phải lớn hơn hoặc bằng 0.',
            'dieu_kien.digits_beetween' => 'Điều kiện áp dụng không được vượt quá 8 chữ số.',
            ...
            'gioi_han_moi_user.required' => 'Trường này không được để trống',
            'gioi_han_moi_user.numeric' => 'Vui lòng nhập đúng định dạng số',
            'gioi_han_moi_user.min'     => 'Giới hạn mỗi user tối thiểu là 1',
            'gioi_han_moi_user.degits_between' => 'Vui lòng nhập trong khoảng từ 1 đến 99',
        ]);
