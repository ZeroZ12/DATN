...
class MaGiamGiaController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        ...
        $data = $request->validate([
            ...
            'gia_tri' => 'required|numeric|min:0|digits_between:1,12',
            'gia_tri_toi_da' => 'required_if:loai,phan_tram|digits_between:1,12',
            'dieu_kien' => 'nullable|numeric|min:0|digits_between:1,12',
            ...
            'gia_tri.digits_beetween' => 'Giá trị mã giảm giá không được vượt quá 99,999,999.',
            ...
            'gia_tri_toi_da.digits_between' => 'Giá trị tối đa không được vượt quá 99,999,999.',
            'dieu_kien.numeric' => 'Điều kiện áp dụng phải là số.',
            'dieu_kien.min' => 'Điều kiện áp dụng phải lớn hơn hoặc bằng 0.',
            'dieu_kien.digits_beetween' => 'Điều kiện áp dụng không được vượt quá 99,999,999.',
