(function ($) {
 ...
 $('<div class="sidebar-pannle-main"><ul><li class="cog-click icon-btn btn-primary" id="cog-click"><i class="fa fa-spin fa-cog"></i></li></ul></div><section class="setting-sidebar"><div class="customizer-header"><div class="theme-title"><div><h4>Tùy Chỉnh Giao Diện</h4><p class="mb-0">Thay đổi theo thời gian thực<i class="fa-solid fa-thumbs-up fa-fw"></i></p></div><div class="flex-grow-1"><a class="icon-btn btn-outline-light button-effect pull-right cog-close" id="cog-close"><i class="fa-solid fa-xmark fa-fw"></i></a></div></div></div><div class="customizer-body"><div class="mb-3 p-2 rounded-3 default-border b-t-primary"><div class="color-header mb-2"><h4>Màu chủ đề:</h4><p class="font-light">Chọn màu nền mong muốn</p></div><div class="color-body d-flex align-items-center justify-space-between"><div class="color-img"><img class="img-fluid" src="#" alt=""><div class="customizer-overlay"></div><div class="button color-btn light-setting"><a href="javascript:void(0)">LIGHT</a></div></div><div class="color-img mx-1"><img class="img-fluid" src="#" alt=""><div class="customizer-overlay"></div><div class="button color-btn dark-setting"><a href="javascript:void(0)">Dark</a></div></div><div class="color-img"><img class="img-fluid" src="" alt=""><div class="customizer-overlay"></div><div class="button color-btn mix-setting"><a href="javascript:void(0)">Mix</a></div></div></div></div><div class="mb-3 p-2 rounded-3 default-border b-t-primary"><div class="sidebar-icon mb-2"><h4>Biểu tượng thanh bên:</h4><p class="font-light">Chọn giữa 2 biểu tượng thanh bên khác nhau.</p></div><div class="sidebar-body form-check radio ps-0"><ul class="radio-wrapper"><li class="default-svg"><input class="form-check-input" id="radio-icon5" type="radio" name="radio2" value="option2" checked=""><label class="form-check-label" for="radio-icon5"><svg class="stroke-icon svg-w-18 me-1"><use href="../assets/svg/iconly-sprite.svg#Activity"></use></svg><span>Stroke</span></label></li><li class="colorfull-svg"><input class="form-check-input" id="radio-icon6" type="radio" name="radio2" value="option2"><label class="form-check-label" for="radio-icon6"><svg class="stroke-icon svg-w-18 me-1"><use href="../assets/svg/iconly-sprite.svg#Activity"></use></svg><span>Biểu tượng đầy màu sắc</span></label></li></ul></div></div><div class="mb-3 p-2 rounded-3 default-border b-t-primary"><div class="theme-layout mb-2"><h4>Kiểu bố cục:</h4><p class="font-light">Chọn kiểu bố cục</p></div><div class="radio-form checkbox-checked"><div class="form-check ltr-setting"><input class="form-check-input" id="flexRadioDefault1" type="radio" name="flexRadioDefault" checked=""><label class="form-check-label" for="flexRadioDefault1">LTR</label></div><div class="form-check rtl-setting"><input class="form-check-input" id="flexRadioDefault2" type="radio" name="flexRadioDefault"><label class="form-check-label" for="flexRadioDefault2">RTL</label></div><div class="form-check box-setting"><input class="form-check-input" id="flexRadioDefault3" type="radio" name="flexRadioDefault"><label class="form-check-label" for="flexRadioDefault3">Box</label></div></div></div><div class="mb-3 p-2 rounded-3 default-border b-t-primary"><div class="sidebar-type mb-2"><h4>Sidebar type:</h4><p class="font-light">Hiển thị thanh bên</p></div><form><div class="sidebar-body form-check radio ps-0"><ul class="radio-wrapper"><li class="vertical-setting"><input class="form-check-input" id="radio-icon" type="radio" name="radio2" value="option2" checked=""><label class="form-check-label" for="radio-icon"><span>Dọc</span></label></li><li class="horizontal-setting"><input class="form-check-input" id="radio-icon4" type="radio" name="radio2" value="option2"><label class="form-check-label" for="radio-icon4"><span>Ngang</span></label></li></ul></div></form></div><div class="customizer-color mb-3 p-2 rounded-3 default-border b-t-primary"><div class="color-picker mb-2"><h4>Màu chữ:</h4></div><ul class="layout-grid"><li class="color-layout" data-attr="color-1" data-primary="#43b9b2" data-secondary="#c280d2"><div></div></li><li class="color-layout" data-attr="color-2" data-primary="#0F2C59" data-secondary="#DAC0A3"><div></div></li><li class="color-layout" data-attr="color-3" data-primary="#7A3E65" data-secondary="#E9A178"><div></div></li><li class="color-layout" data-attr="color-4" data-primary="#025464" data-secondary="#E57C23"><div></div></li><li class="color-layout" data-attr="color-5" data-primary="#3E64FF" data-secondary="#5EDFFF"><div></div></li><li class="color-layout" data-attr="color-6" data-primary="#506D84" data-secondary="#D4B499"><div></div></li></ul></div></div></section>')
.appendTo($("body"));
